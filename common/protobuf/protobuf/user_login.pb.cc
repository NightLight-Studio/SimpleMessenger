...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_5flogin_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::UserLogin, nt_type_),
  PROTOBUF_FIELD_OFFSET(::UserLogin, user_id_),
  PROTOBUF_FIELD_OFFSET(::UserLogin, name_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_user_5flogin_2eproto = {
  false, false, 87, descriptor_table_protodef_user_5flogin_2eproto, "user_login.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "UserLogin.name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
